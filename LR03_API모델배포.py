...
class ModelDeployment():
    ...
    def registerModelFromExperimentRun(self, modelName, experimentId, experimentRunId, modelPath, sessionId):
        ...
        model_name = 'Fraud_' + username + "-" + sessionId
    ...
    def createPRDProject(self):
        ...
        createProjRequest = {"name": "MLOps_PROD1", "template":"git", "git_url":"https://github.com/violetamineral/MLOps_Fins_PROD.git"}
...
DATE = date.today()
experimentName = "LR-fraud-{0}".format(DATE)
...
modelPath = "artifacts"
modelName = "Fraud-" + username + "-" + sessionId
...
model_request = {"dataframe_split": {"columns": ["나이", "카드잔액", "계좌잔액", "모기지잔액", "비밀계좌잔액", "저축계좌잔액", "비밀저축계좌잔액", "총금액", "신용대출잔액", "담보대출잔액", "총대출잔액", "경도", "위도", "거래금액"],
                                     "data":[[35.5, 20000.5, 3900.5, 14000.5, 2944.5, 3400.5, 12000.5, 29000.5, 1300.5, 15000.5, 10000.5, 37.56100278, 126.9996417, 92960]]}}
